//
//  WinnesTableViewController.swift
//  CampeoesDaCopa
//
//  Created by Guilherme Golfetto on 01/10/21.
//

import UIKit

class WinnesTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let worldCup = worldCups[tableView.indexPathForSelectedRow!.row] // qual o indexpath da linha selecionada
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let wordCup = worldCups[indexPath.row]
